...
function initMap() {
    const map = new google.maps.Map(document.getElementById("map"), {
        zoom: 18,
        center: { lat: 39.647940, lng: -104.821339 },
        mapTypeId: "satellite",
    ...
    marker1 = new google.maps.Marker({
        position: { lat: 39.649937, lng: -104.821138 },
        map: map,
        draggable: true
    })
    marker2 = new google.maps.Marker({
        position: { lat: 39.647940, lng: -104.821339 },
        map: map,
        draggable: true
    })
    marker3 = new google.maps.Marker({
        position: { lat: 39.646676, lng: -104.821394 },
        map: map,
        draggable: true
    })
...
function update() {
    ...
    document.getElementById('hole').innerHTML = "Hole 8:"
