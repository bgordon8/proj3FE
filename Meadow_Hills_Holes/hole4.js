...
function initMap() {
    const map = new google.maps.Map(document.getElementById("map"), {
        zoom: 20,
        center: { lat: 39.646840, lng: -104.825448 },
        mapTypeId: "satellite",
    ...
    marker1 = new google.maps.Marker({
        position: { lat: 39.647475, lng: -104.825614 },
        map: map,
        draggable: true
    })
    marker2 = new google.maps.Marker({
        position: { lat: 39.646840, lng: -104.825448 },
        map: map,
        draggable: true
    })
    marker3 = new google.maps.Marker({
        position: { lat: 39.646101, lng: -104.825229 },
        map: map,
        draggable: true
    })
...
function update() {
    ...
    document.getElementById('hole').innerHTML = "Hole 4:"
