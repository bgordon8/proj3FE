...
function initMap() {
    const map = new google.maps.Map(document.getElementById("map"), {
        zoom: 19,
        center: { lat: 39.645989, lng: -104.820917 },
        mapTypeId: "satellite",
    ...
    marker1 = new google.maps.Marker({
        position: { lat: 39.645871, lng: -104.819797 },
        map: map,
        draggable: true
    })
    marker2 = new google.maps.Marker({
        position: { lat: 39.645989, lng: -104.820917 },
        map: map,
        draggable: true
    })
    marker3 = new google.maps.Marker({
        position: { lat: 39.646045, lng: -104.821968 },
        map: map,
        draggable: true
    })
...
function update() {
    ...
    document.getElementById('hole').innerHTML = "Hole 2:"
