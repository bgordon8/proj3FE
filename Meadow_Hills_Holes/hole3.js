...
function initMap() {
    const map = new google.maps.Map(document.getElementById("map"), {
        zoom: 18,
        center: { lat: 39.646526, lng: -104.824231 },
        mapTypeId: "satellite",
    ...
    marker1 = new google.maps.Marker({
        position: { lat: 39.645686, lng: -104.822274 },
        map: map,
        draggable: true
    })
    marker2 = new google.maps.Marker({
        position: { lat: 39.646526, lng: -104.824231 },
        map: map,
        draggable: true
    })
    marker3 = new google.maps.Marker({
        position: { lat: 39.647953, lng: -104.825581 },
        map: map,
        draggable: true
    })
...
function update() {
    ...
    document.getElementById('hole').innerHTML = "Hole 3:"
