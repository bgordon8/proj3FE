...
function initMap() {
    const map = new google.maps.Map(document.getElementById("map"), {
        zoom: 19,
        center: { lat: 39.650561, lng: -104.823200 },
        mapTypeId: "satellite",
    ...
    marker1 = new google.maps.Marker({
        position: { lat: 39.650334, lng: -104.820482 },
        map: map,
        draggable: true
    })
    marker2 = new google.maps.Marker({
        position: { lat: 39.650128, lng: -104.823537 },
        map: map,
        draggable: true
    })
    marker3 = new google.maps.Marker({
        position: { lat: 39.651073, lng: -104.825679 },
        map: map,
        draggable: true
    })
...
function update() {
    ...
    document.getElementById('hole').innerHTML = "Hole 10:"
