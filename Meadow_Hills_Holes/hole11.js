...
function initMap() {
    const map = new google.maps.Map(document.getElementById("map"), {
        zoom: 19,
        center: { lat: 39.649601, lng: -104.824845 },
        mapTypeId: "satellite",
    ...
    marker1 = new google.maps.Marker({
        position: { lat: 39.650896, lng: -104.826201 },
        map: map,
        draggable: true
    })
    marker2 = new google.maps.Marker({
        position: { lat: 39.649762, lng: -104.824315 },
        map: map,
        draggable: true
    })
    marker3 = new google.maps.Marker({
        position: { lat: 39.648400, lng: -104.824280 },
        map: map,
        draggable: true
    })
...
function update() {
    ...
    document.getElementById('hole').innerHTML = "Hole 11:"
